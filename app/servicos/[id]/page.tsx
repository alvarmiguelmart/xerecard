    ...
    <>
      ...
      <main className="page-depth py-8 md:py-12">
        <section className="container-page grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
          <div className="relative h-[min(78svh,50rem)] min-h-[24rem] overflow-hidden rounded-xl bg-cloud md:min-h-[38rem] lg:sticky lg:top-24">
            <Image
              src={service.image}
              alt=""
              fill
          ...
          <div className="glass-panel-strong motion-rise rounded-xl p-6 lg:p-8">
            <div className="flex flex-wrap items-center gap-3">
              ...
              {service.verified ? (
                <span className="inline-flex items-center gap-1 rounded-full bg-cloud px-3 py-1 text-xs font-black text-ink">
            ...
            <div className="mt-6 grid gap-3 rounded-xl border border-ink/10 bg-cloud p-4">
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              {service.tags.map((tag) => (
                <span
                  key={tag}
                  className="rounded-full border border-ink/10 bg-paper px-3 py-1 text-sm font-bold text-ink/65"
                >
                  {tag}
                </span>
              ))}
